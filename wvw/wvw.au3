			...
			If ($map_objects[$j][0] <> "") Then
				If ($map_objects[$j][0] <> $last_mapItems[$j][0] Or $firststart == 1) Then
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 6) Then
						$speldan_icon = writepng(@ScriptDir & "\images\icons\camp_blue.png", 128, 108, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 6) Then
						$speldan_icon = writepng(@ScriptDir & "\images\icons\camp_green.png", 128, 108, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 17) Then
						$mendon_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 200, 96, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 17) Then
						$mendon_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 200, 96, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 20) Then
						$veloka_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 328, 92, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 20) Then
						$veloka_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 328, 92, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 1) Then
						$overlook_icon = writepng(@ScriptDir & "\images\icons\keep_blue.png", 278, 130, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 1) Then
						$overlook_icon = writepng(@ScriptDir & "\images\icons\keep_green.png", 278, 130, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 18) Then
						$anza_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 192, 190, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 18) Then
						$anza_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 192, 190, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 19) Then
						$ogrewatch_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 316, 166, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 19) Then
						$ogrewatch_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 316, 166, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 5) Then
						$pangloss_icon = writepng(@ScriptDir & "\images\icons\camp_blue.png", 368, 146, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 5) Then
						$pangloss_icon = writepng(@ScriptDir & "\images\icons\camp_green.png", 368, 146, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 10) Then
						$rogue_icon = writepng(@ScriptDir & "\images\icons\camp_blue.png", 88, 248, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 10) Then
						$rogue_icon = writepng(@ScriptDir & "\images\icons\camp_green.png", 88, 248, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 12) Then
						$wildcreek_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 150, 276, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 12) Then
						$wildcreek_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 150, 276, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 9) Then
						$stonemist_icon = writepng(@ScriptDir & "\images\icons\castle_blue.png", 254, 274, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 9) Then
						$stonemist_icon = writepng(@ScriptDir & "\images\icons\castle_green.png", 254, 274, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 21) Then
						$durios_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 350, 262, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 21) Then
						$durios_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 350, 262, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 8) Then
						$umber_icon = writepng(@ScriptDir & "\images\icons\camp_blue.png", 412, 250, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 8) Then
						$umber_icon = writepng(@ScriptDir & "\images\icons\camp_green.png", 412, 250, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 22) Then
						$bravost_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 446, 310, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 22) Then
						$bravost_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 446, 310, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 11) Then
						$aldon_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 56, 310, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 11) Then
						$aldon_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 56, 310, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 3) Then
						$lowlands_icon = writepng(@ScriptDir & "\images\icons\keep_blue.png", 98, 360, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 3) Then
						$lowlands_icon = writepng(@ScriptDir & "\images\icons\keep_green.png", 98, 360, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 14) Then
						$klovan_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 188, 354, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 14) Then
						$klovan_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 188, 354, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 4) Then
						$golanta_icon = writepng(@ScriptDir & "\images\icons\camp_blue.png", 186, 416, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 4) Then
						$golanta_icon = writepng(@ScriptDir & "\images\icons\camp_green.png", 186, 416, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 13) Then
						$jerrifer_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 128, 410, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 13) Then
						$jerrifer_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 128, 410, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 16) Then
						$quentin_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 286, 380, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 16) Then
						$quentin_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 286, 380, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 7) Then
						$danelon_icon = writepng(@ScriptDir & "\images\icons\camp_blue.png", 320, 438, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 7) Then
						$danelon_icon = writepng(@ScriptDir & "\images\icons\camp_green.png", 320, 438, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 15) Then
						$langor_icon = writepng(@ScriptDir & "\images\icons\tower_blue.png", 394, 424, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 15) Then
						$langor_icon = writepng(@ScriptDir & "\images\icons\tower_green.png", 394, 424, $map_gui)
					EndIf
					...
					ElseIf ($map_objects[$j][0] == "Blue" And $j == 2) Then
						$valley_icon = writepng(@ScriptDir & "\images\icons\keep_blue.png", 394, 360, $map_gui)
					ElseIf ($map_objects[$j][0] == "Green" And $j == 2) Then
						$valley_icon = writepng(@ScriptDir & "\images\icons\keep_green.png", 394, 360, $map_gui)
					EndIf
					EndIf
					If (1 > 2) Then
						If ($l3_1 <> "") Then
